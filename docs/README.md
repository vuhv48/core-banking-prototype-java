# Tài liệu yêu cầu — Bank + Exchange Demo
...
1. **BRD** — hiểu *tại sao* có hệ thống  
2. **URD** — hiểu *ai dùng gì*  
3. **SRS** — hiểu *phần mềm phải làm gì*  
4. **TAI-LIEU** — hiểu *code triển khai thế nào*
